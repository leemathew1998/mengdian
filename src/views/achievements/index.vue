...
请输入供电服务中心名称" style="width: 100%" @search="onSearch" />
					<a-table :columns="columns" :data-source="data" size="small"></a-table>
				</div>
			</div>
		</div>
		<div class="wrap-center">
			<div class="box">
				...
				<Tables :columns="bigcolumns" :data="bigdata" operationName="派单" :tableLoading="tableLoading">
					<template v-slot="slotProps">
						<a-button size="small" type="primary" @click.stop="operation(slotProps.table_key)">查看详情
						</a-button>
					</template>
				</Tables>
			</div>
		...
		<div class="wrap-right">
			<div class="box">
				...
				<a-input-search placeholder="
请输入供电所名称" style="width: 100%" @search="onSearch" />
				<div class="show">
					<p>最高 {{}}</p>
					<p>最低 {{}}</p>
					<p>平均 {{}}</p>
				</div>
				<a-table :columns="centercolumns" :data-source="centerdata" size="small"></a-table>
